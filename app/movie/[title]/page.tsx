...
export default function MoviePage({ params }: { params: { title: string } }) {
  ...
  // Definir un precio de ticket aleatorio entre $5 y $20
  const ticketPrice = (Math.random() * (20 - 5) + 5).toFixed(2);
  ...
  return (
    <div className="flex flex-col items-center p-10">
      <div className="bg-white shadow-lg rounded-xl p-6 w-96">
        ...
        <button className="mt-6 bg-blue-600 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded w-full">
          Comprar Ticket
        </button>
      </div>
    </div>
